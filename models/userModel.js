...
const userSchema = new mongoose.Schema({
  ...
  email: {
    type: String,
    required: [true, 'An email must be provided for a user'],
    unique: true,
    lowercase: true,
...
userSchema.pre('save', async function (next) {
  ...
  //HASHING ALGORITHM CALLED BCRYPT
...
VERIFYING
CLIENT (ORIGINAL SIGNATURE) JWT --> Header + Payload + Secret = Test signature

Therfore compare test signature with original signature.
